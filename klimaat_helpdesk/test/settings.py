...
ROOT_URLCONF = "klimaat_helpdesk.test.urls"
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///test_klimaat_helpdesk.db"),
}
...
WAGTAIL_SITE_NAME = "Wagtail klimaat-helpdesk test site"
