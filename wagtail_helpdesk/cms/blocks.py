...
class AnswerImageBlock(blocks.StructBlock):
    image = ImageChooserBlock(
        help_text="The recommended aspect ratio is landscape with a size of of 1920x1080. Portrait images not recommended."
    )
...
class AnswerOriginBlock(blocks.StructBlock):
    ...
    content = blocks.RichTextBlock(
        help_text="Clarification of the answer's origin",
        features=(
            "bold",
            "italic",
            "link",
