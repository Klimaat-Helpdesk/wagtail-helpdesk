...
from wagtail_helpdesk.cms.models import AnswerCategory
...
class ClimateQuestionForm(forms.Form):
    ...
    categories = forms.MultipleChoiceField(
        widget=TagWidget, choices=choices, required=False
    )
    main_question = forms.CharField(
        max_length=1000, required=True, label="Mijn vraag is*"
    )
