...
class Expert(models.Model):
    ...
    panels = [
        ...
        FieldPanel(
            "areas_expertise",
            heading="Areas of expertise. A maximum of 16 characters per word is recommended for optimal mobile display",
        ),
        FieldPanel("website"),
    ...
    def get_answered_questions(self):
        ...
        return [
            l.answer for l in question_links if l.answer is not None and l.answer.live
        ]
